...
Ionic Studio uses the Ionic CLI command `alitacordova resources` to generate app resources. More information about icons and splash screens can be found in [the CLI docs](/docs/cli/commands/cordova-resources).
