...
Remember `alitaserve`? That was Live Reload working in the browser, allowing us to iterate quickly.
...
```shell
$ alitacap run ios -l --external

$ alitacap run android -l --external
```
