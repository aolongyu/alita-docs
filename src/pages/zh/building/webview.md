...
previousUrl: '/building/contributing'
nextText: 'Ionic Storage'
nextUrl: '/building/storage'
---
...
The Web View is automatically provided for apps integrated with [Capacitor](/faq/glossary#capacitor).

For [Cordova](/faq/glossary#cordova), Ionic maintains a <a href="https://github.com/ionic-team/cordova-plugin-ionic-webview" target="_blank">Web View plugin</a>. The plugin is provided by default when using the Ionic CLI.

## What is a Web View?

Ionic apps are built using [web technologies](/faq/glossary#web-standards) and are rendered using Web Views, which are a full screen and full-powered web browser.
...
![webview architecture](/assets/img/building/webview-architecture.png)
...
Web Views enforce [CORS](/faq/glossary#cors), so it's important that external services properly handle cross-origin requests. See the [CORS FAQs](/faq/cors) for information on dealing with CORS in Ionic apps.
...
For Cordova apps, the [Ionic Web View plugin](https://github.com/ionic-team/cordova-plugin-ionic-webview) provides a utility function for converting File URIs: `window.Ionic.WebView.convertFileSrc()`. There is also a corresponding Ionic Native plugin: [`@ionic-native/ionic-webview`](/native/ionic-webview/).
