...
export default (props) => {
  ...
  if (releases.length === 0) {
    return [
      <h1>{page.title}</h1>,
      <p>Unable to load Releases. Please see all releases on <a href="https://github.com/alitajs/alita/releases/" target="_blank">GitHub</a>.</p>
    ];
  }
  ...
  return (
    <article>
      ...
      <blockquote>
        To see more releases, visit <a href="https://github.com/alitajs/alita/releases/" target="_blank">GitHub</a>.
      </blockquote>
    </article>
  );
};
