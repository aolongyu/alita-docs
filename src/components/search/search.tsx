    ...
    return (
      <div class="Search__Defaults">
        <div class="Search__Defaults__Section">
          ...
          <ul>
            <li><a href="/installation/cli"><Book/><strong>Installation Guide</strong> | Installation</a></li>
            <li><a href="/building/running"><Book/><strong>Running an App</strong> | Building</a></li>
            <li><a href="/layout/structure"><Book/><strong>App Structure</strong> | Layout</a></li>
            <li><a href="/theming/basics"><Book/><strong>Theming Basics</strong> | Theming</a></li>
          </ul>
        </div>
        <div class="Search__Defaults__Section">
          <h4>Common topics</h4>
          <ul>
            <li><a href="/building/testing"><Book/><strong>Testing</strong> | Building</a></li>
            <li><a href="/building/cross-platform#storage"><Book/><strong>Storage</strong> | Building</a></li>
            <li><a href="/lifecycle/angular"><Book/><strong>Life Cycle Events</strong> | Angular</a></li>
            <li><a href="/navigation/angular"><Book/><strong>Navigation</strong> | Angular</a></li>
          </ul>
        </div>
        <div class="Search__Defaults__Section">
          <h4>UI Components</h4>
          <ul>
            <li><a href="/api/button"><Book/><strong>ion-button</strong> | Buttons</a></li>
            <li><a href="/api/card"><Book/><strong>ion-card</strong> | Cards</a></li>
            <li><a href="/api/loading"><Book/><strong>ion-loading</strong> | Progress Indicators</a></li>
            <li><a href="/api/tabs"><Book/><strong>ion-tabs</strong> | Tabs</a></li>
          </ul>
        </div>
        <div class="Search__Defaults__Section">
          <h4>Native</h4>
          <ul>
            <li><a href="/enterprise/camera"><Book/><strong>Camera</strong> | Native EE</a></li>
            <li><a href="/enterprise/identity-vault"><Book/><strong>Identity Vault</strong> | Native EE</a></li>
            <li><a href="/native/firebase"><Book/><strong>Firebase</strong> | Native CE</a></li>
            <li><a href="/native/barcode-scanner"><Book/><strong>Barcode Scanner</strong> | Native CE</a></li>
          </ul>
        </div>
      </div>
    );
